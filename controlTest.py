...
class XboxController:
    ...
    def read(self):
        """
        Read and return current joystick and trigger states.
        Returns a dict with normalized values between -1 and 1.
        """
        pygame.event.pump()
        ...
        # trigger config
        trigger_L = -self.joy.get_axis(4)   # left trigger (unpressed --> +1.00   ;   pressed --> -1.00)
        trigger_R = -self.joy.get_axis(5)   # right trigger (unpressed --> +1.00   ;   pressed --> -1.00)
